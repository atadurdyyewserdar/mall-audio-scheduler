...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    "tk": {
        ...
        "Adjust volume": "Sesi sazla",
        "Adjust volume…": "Sesi sazla…",
        "No change": "Üýtgemesiz",
        "Turns this recording down (or up, within headroom) relative to the others.":
            "Bu ýazgyny beýlekilere görä peseldýär (ýa-da boş ýer bar bolsa, ýokarlandyrýar).",
        "Reset": "Asyl ýagdaýa getir",
        "Preview": "Diňle",
        "Save": "Ýatda sakla",
    ...
    "ru": {
        ...
        "Adjust volume": "Настроить громкость",
        "Adjust volume…": "Настроить громкость…",
        "No change": "Без изменений",
        "Turns this recording down (or up, within headroom) relative to the others.":
            "Делает эту запись тише (или громче — если есть запас) по сравнению с остальными.",
        "Reset": "Сбросить",
        "Preview": "Прослушать",
        "Save": "Сохранить",
